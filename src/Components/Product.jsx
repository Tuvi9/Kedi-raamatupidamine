...
export default function Product() {
    return(
        ...
        <div className='flex flex-col text-center pt-8'>
            ...
            <p className='text-2xl pt-6 break-words max-w-4xl mx-auto xs:text-base xs:text-left xs:p-4'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.</p>
        </div>
        <div className="grid justify-center grid-cols-3 grid-rows-2 h-[600px] xs:grid-cols-2">
            {productDesc.map(function(data) {
                return (
                    <div className='flex justify-center items-center h-full p-4' key={data.name}>
                        <div className='border-4 p-4 border-purple-700 text-white text rounded-md w-[300px] max-w-[300px] max-h-[225px] h-[225px] break-words xs:w-[170px] xs:h-[150px]'
                            style={{
                        ...
                        >
                            <div className='text-2xl flex flex-col justify-between h-full xs:text-xs'>
                                {data.name}
