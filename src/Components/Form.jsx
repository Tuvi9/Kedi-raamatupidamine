        ...
        <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto mt-8 px-4">
            ...
            <form className="space-y-4 pb-[100px] w-full">
                ...
                <textarea
                    ...
                    placeholder="Sõnum"
                />
                <button className='flex flex-col mx-auto border-2 p-2 px-4 rounded-md border-purple-700 bg-purple-700 text-white font-bold text-xl xs:text-lg hover:bg-purple-800 transition-colors'>
                    Lorem Ipsum
                </button>
            </form>
        </div>
